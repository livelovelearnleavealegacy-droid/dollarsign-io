  ...
  return (
    <div style={{ maxWidth: 520, margin: "0 auto", padding: "48px 20px 100px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 24 }}>
        <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 16, letterSpacing: 1.5, color: "#8A8F98" }}>{trackingId}</span>
      </div>

      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
        <FileCheck size={18} color="var(--accent)" />
        <h1 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 21, fontWeight: 700, color: "var(--ink)", margin: 0 }}>
      ...
      <div style={{ background: "var(--card)", boxShadow: "var(--shadow)", borderRadius: 10, padding: 20, fontSize: 16, color: "#3A3F47", lineHeight: 1.65 }}>
        <p style={{ marginTop: 0 }}>
      ...
      {error && <p style={{ color: "#C1440E", fontSize: 16, marginTop: 10 }}>{error}</p>}
